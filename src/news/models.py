...
class News(models.Model):
    category = models.ForeignKey(Category, verbose_name=_('Category'), on_delete=models.CASCADE, related_name="News")
    title = models.CharField(max_length=255, verbose_name=_('Гарчиг'), unique=True)
    slug = models.SlugField(max_length=255, verbose_name=_('Слаг'), unique=True)
    ...
    created_on = models.DateTimeField(auto_now_add=True, verbose_name=_('Хэзээ үүссэн'))
